        ...
        <form action="" method="post"> 
            <div class="inscription-form">
                <div class="inscription-box-element">
                    ...
                    <input class="inscription-input"  placeholder='code' type='text'/>
                </div>
                <div class="inscription-box-element">
                    <label>Adresse Mail</label>
                    <input class="inscription-input" placeholder="email" type="text" />
                </div>
                <div class="inscription-box-element"> 
                    <label>Mot de Passe</label>
                    <input class="inscription-input" placeholder='password' type='password'/>
                </div>
                <div class="inscription-box-element">
                    <label>Confirmer votre mot de passe</label>
                    <input class="inscription-input" placeholder='confirm password' type="password" />
                </div>   
